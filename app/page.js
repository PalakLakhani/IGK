    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-pink-50 via-white to-purple-50">
      ...
      <section className="relative h-[700px] overflow-hidden">
        {heroEvents.length > 0 ? (
          ...
          /* Hero with Static Image Background (no video) */
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4 max-w-lg sm:max-w-none mx-auto">
            <Button size="lg" asChild className="bg-white text-purple-600 hover:bg-gray-100 font-bold text-base sm:text-xl px-8 sm:px-10 py-6 sm:py-8 rounded-full shadow-2xl w-full sm:w-auto justify-center">
              <Link href="/community">
