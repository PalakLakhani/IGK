export const brands = [
  ...
  },
  {
    id: 'igk',
    name: 'IGK',
    fullName: 'Indo-German Konnekt',
    slug: 'igk',
    description: 'Main umbrella brand connecting cultures',
    ...
    instagram: 'https://www.instagram.com/igk_events',
    color: 'from-blue-500 to-purple-500',
    about: 'Indo-German Konnekt (IGK) is the umbrella organization fostering cultural exchange between India and Germany through diverse events, festivals, and community initiatives across the nation.',
    categories: ['All']
  }
];
