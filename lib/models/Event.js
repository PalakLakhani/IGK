...
export class Event {
  ...
  static async create(eventData) {
    ...
    const event = {
      ...
      // Content fields - structured for different contexts
      heroTagline: eventData.heroTagline || '', // Max 140 chars - used ONLY in homepage hero
      shortSummary: eventData.shortSummary || '', // Max 220 chars - used on event cards
      description: eventData.description || '', // Full description - used ONLY on event detail page
      
      // Location - NO fallbacks, show only what's stored
      city: eventData.city || '',
      ...
      // Event details - arrays, hide section if empty
